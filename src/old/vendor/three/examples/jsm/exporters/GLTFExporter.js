...
class GLTFExporter {
	 ...
	 * @param  {Three_app or [THREE.Scenes]} input   Three_app or Array of THREE.Scenes
...
class GLTFWriter {
	...
	/**
	 * Process Three_app
	 * @param  {Scene} node Three_app to process
	 */
	processScene( scene ) {
	...
	/**
	 * Creates a Three_app to hold a list of objects and parse it
