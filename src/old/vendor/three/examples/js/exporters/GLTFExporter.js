( function () {
   ...
   * @param  {Three_app or [THREE.Scenes]} input   THREE.Three_app or Array of THREE.Scenes
 ...
 */
   ...
   */
		...
		/**
   * Process THREE.Three_app
   * @param  {Scene} node THREE.Three_app to process
   */
		...
		/**
   * Creates a THREE.Three_app to hold a list of objects and parse it
